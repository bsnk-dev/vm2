...
class NodeVM extends VM {
   ...
   * @param {boolean} [options.require.allowModifyingBuiltin=false] - Boolean which indicates if builtin modules can be modified by sandboxed code. 
   * (not recommended)
   ...
   * @param {boolean} [options.require.allowCaching=true] - Enable/disable caching of modules.
